...
// BITCOIN  this.network.magicBytes = hex('f9beb4d9');
  this.network.magicBytes = hex('e6e8e9e5'); //ppcoin src/protocol.cpp
...
//    'timestamp': 1231006505,
    'timestamp': 1345084287, //ppcoin timestamp
